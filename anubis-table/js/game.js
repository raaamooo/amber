document.addEventListener('DOMContentLoaded', () => {
    ...
    const routerQuestion = {
        text: "Mortal, what does your soul hunger for?",
        attribute: "category",
        options: [
            { label: "A worthy feast", value: "meal" },
            { label: "A sacred drink", value: "drink" },
            { label: "A sweet offering for the gods", value: "dessert" }
        ]
    };

    const drinkQuestions = [
        {
            text: "Shall it be hot from Ra's flame, or cold as the desert night?", attribute: "temp", weight: 4,
        ...
        {
            text: "Which essence calls to your spirit?", attribute: "flavor", weight: 5,
        ...
        {
            text: "What purpose does this elixir serve, traveler?", attribute: "purpose", weight: 4,
            options: [ { label: "Wake me up and energize me", value: "energize" }, { label: "Calm me down and relax me", value: "calm" }, { label: "Refresh me from the heat", value: "refresh" }, { label: "Indulge me like a treat", value: "indulge" }, { label: "Aid my digestion", value: "digestion" } ]
        },
        {
            text: "How shall it flow upon your tongue?", attribute: "thickness", weight: 3,
        ...
        {
            text: "How daring is your soul today?", attribute: "adventure", weight: 2,
    ...
    const mealQuestions = [
        {
            text: "How great is the void in your belly?", attribute: "hunger", weight: 3,
            options: [ { label: "A light bite", value: "light" }, { label: "A normal portion", value: "normal" }, { label: "A pharaoh-sized feast", value: "feast" } ]
        },
        {
            text: "Which flavor shall please your tongue?", attribute: "flavor", weight: 5,
        ...
        {
            text: "What gift of the earth shall feed you?", attribute: "protein", weight: 4,
            options: [ { label: "Beef or red meat", value: "beef" }, { label: "Chicken or poultry", value: "chicken" }, { label: "Vegetarian or plant-based", value: "vegetarian" }, { label: "Carb-heavy and filling", value: "carb-heavy" }, { label: "I am flexible", value: "flexible" } ]
        },
        {
            text: "What texture pleases your senses?", attribute: "texture", weight: 4,
        ...
        {
            text: "For what occasion do you partake in this offering?", attribute: "occasion", weight: 3,
    ...
    const dessertQuestions = [
        {
            text: "How sweet shall the gods make your reward?", attribute: "sweetness", weight: 4,
        ...
        {
            text: "Warm from the hearth, or cool from the temple stone?", attribute: "temp", weight: 3,
            options: [ { label: "Warm and freshly served", value: "hot" }, { label: "Chilled and cool", value: "cold" }, { label: "Either works", value: "flexible" } ]
        },
        {
            text: "What texture shall delight your senses?", attribute: "texture", weight: 5,
        ...
        {
            text: "Which sacred lineage of sweet calls to you?", attribute: "family", weight: 4,
        ...
        {
            text: "How heavily shall this blessing rest upon you?", attribute: "weight", weight: 3,
    ...
    function createGoldDust() {
        ...
        for (let i = 0; i < 40; i++) {
            ...
            particle.style.boxShadow = '0 0 5px #d4af37';
